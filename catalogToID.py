...
for i in range(len(lines)):
    ...
    # If the find_all method returns an empty list or if the site suggests that you misspelled your query, append to dev_IDs. Otherwise, call the companyNames function.
